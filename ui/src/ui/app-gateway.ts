...
export function connectGateway(host: GatewayHost) {
  ...
  host.client = new GatewayBrowserClient({
    ...
    onHello: (hello) => {
      ...
      void loadAssistantIdentity(host as unknown as wehelperApp);
      void loadAgents(host as unknown as wehelperApp);
      void loadNodes(host as unknown as wehelperApp, { quiet: true });
      void loadDevices(host as unknown as wehelperApp, { quiet: true });
...
function handleGatewayEventUnsafe(host: GatewayHost, evt: GatewayEventFrame) {
  ...
  if (evt.event === "chat") {
    ...
    const state = handleChatEvent(host as unknown as wehelperApp, payload);
    if (state === "final" || state === "error" || state === "aborted") {
      ...
      if (runId && host.refreshSessionsAfterChat.has(runId)) {
        ...
        if (state === "final") {
          void loadSessions(host as unknown as wehelperApp, {
    ...
    if (state === "final") {
      void loadChatHistory(host as unknown as wehelperApp);
    }
    return;
  }
