...
export async function refreshActiveTab(host: SettingsHost) {
  ...
  if (host.tab === "instances") {
    await loadPresence(host as unknown as wehelperApp);
  }
  if (host.tab === "sessions") {
    await loadSessions(host as unknown as wehelperApp);
  }
  if (host.tab === "cron") {
    await loadCron(host);
  }
  if (host.tab === "wecom") {
    ...
    await loadWecomKfStatus(app);
  }
  if (host.tab === "skills") {
    await loadSkills(host as unknown as wehelperApp);
  }
  if (host.tab === "agents") {
    const app = host as unknown as wehelperApp;
  ...
  if (host.tab === "nodes") {
    await loadNodes(host as unknown as wehelperApp);
    await loadDevices(host as unknown as wehelperApp);
    await loadConfig(host as unknown as wehelperApp);
    await loadExecApprovals(host as unknown as wehelperApp);
  }
  if (host.tab === "chat") {
  ...
  if (host.tab === "logs") {
    ...
    await loadLogs(host as unknown as wehelperApp, { reset: true });
...
export async function loadOverview(host: SettingsHost) {
  await Promise.all([
    loadChannels(host as unknown as wehelperApp, false),
    loadPresence(host as unknown as wehelperApp),
    loadSessions(host as unknown as wehelperApp),
    loadCronStatus(host as unknown as wehelperApp),
    loadDebug(host as unknown as wehelperApp),
  ]);
}

export async function loadChannelsTab(host: SettingsHost) {
  await Promise.all([
    loadChannels(host as unknown as wehelperApp, true),
    loadConfigSchema(host as unknown as wehelperApp),
    loadConfig(host as unknown as wehelperApp),
  ]);
}
...
export async function loadCron(host: SettingsHost) {
  await Promise.all([
    loadChannels(host as unknown as wehelperApp, false),
    loadCronStatus(host as unknown as wehelperApp),
    loadCronJobs(host as unknown as wehelperApp),
  ]);
}
